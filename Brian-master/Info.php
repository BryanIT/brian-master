...
if (isset($_POST['submit_reg'])){
    if ($_POST['passcode'] === $_POST['confirmpasscode']){
        ...
        $NokFname =$db->real_escape_string(htmlspecialchars($_POST["NokFname"]));
        $NokSurname =$db->real_escape_string(htmlspecialchars($_POST["NokSurname"]));
        $NokRelationship =$db->real_escape_string(htmlspecialchars($_POST['NokRelationship']));
        $NokContact =$db->real_escape_string(htmlspecialchars($_POST["NokContact"]));
        $NokAddress1 =$db->real_escape_string(htmlspecialchars($_POST["NokAddress1"]));
        $NokAddress2 =$db->real_escape_string(htmlspecialchars($_POST["NokAddress2"]));
        $NokPostalcode =$db->real_escape_string(htmlspecialchars($_POST["NokPostalcode"]));
        $NokCity =$db->real_escape_string(htmlspecialchars($_POST["NokCity"]));
        ...
        if ($email_result->num_rows > 0){
            ...
            if ($username_result->num_rows > 0){
                ...
                if (count($errors) == 0) {
                    $query = "INSERT INTO `users`(`username`, `password`, `firstname`, `lastname`, `middlename`, `phonenumber`, `email`,`NokFname`, `NokSurname`, `NokRelationship`, `NokContact`, `NokAddress1`, `NokAddress2`, `NokPostalcode`, `NokCity`) VALUES ('$username','$passcode','$firstname','$lastname','$middlename','$phonenumber','$email','$NokFname','$NokSurname','$NokRelationship','$NokContact','$NokAddress1','$NokAddress2','$NokPostalcode','$NokCity')";
                    $run = $db->query($query);
                    if ($run) {
        ...
        <div class="col-md-11 elements">
          ...
          <div class="row">
            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
              <label for="firstname"><span class="req">* </span>Next of Kin First name : </label>
              <input class="form-control" type="text" name="NokFname" id = "txt" onkeyup = "Validate(this)" required />
              <div id="errFirst">
              </div>
            </div>

              <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
                <label for="surname"><span class="req">* </span>Next of Kin  Surname : </label>
                <input class="form-control" type="text" name="NokSurname" id = "txt"
          ...
          <div class="form-group">
            <label for="email"><span class="req">* </span>Next of Kin  Relationship :</label>
            <input class="form-control" required type="text" name="NokRelationship" id = "email"  onchange="email_validate(this.value);" />
            <div class="status" id="status">
            </div>
          </div>

          <div class="form-group">
            <label for="phonenumber"><span class="req">* </span>Next of Kin  Contact :</label>
            <input class="form-control" required type="tel" maxlength="10" name="NokContact" id="phone"  placeholder="Phone Number"  onchange="email_validate(this.value);" />
            <div class="status" id="status">
            </div>
          </div>
          ...
          <div class="row">
            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
              <label for="address1"><span class="req">* </span>Next of Kin  Address 1 : </label>
              <input required type="text" name="NokAddress1" id="phone" class="form-control"
                maxlength="10" onkeyup="validate(this);"/>
            </div>

            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
              <label for="Postcode"><span class="req">* </span>Next of Kin  Postal code : </label>
              <input required type="text" name="NokPostalcode" id="postcode" class="form-control"
                maxlength="10" onkeyup="validate(this);"/>
            </div>
          </div>
          ...
          <div class="row">
            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
              <label for="address2">Next of Kin  Address 2 : </label>
              <input type="text" name="NokAddress2" id="phone" class="form-control" onkeyup="validate(this);"/>
            </div>

            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
              <label for="dateofbirth"><span class="req">* </span>Next of Kin  City : </label>
              <input required type="text" name="NokCity" id="city" class="form-control" onkeyup="validate(this);"/>
            </div>
          </div>
